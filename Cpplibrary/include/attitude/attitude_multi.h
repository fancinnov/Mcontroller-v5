...
#define AC_ATTITUDE_CONTROL_SLEW_YAW_DEFAULT_DS        30      // constraint on yaw angle error in degrees.  This should lead to maximum turn rate of 10deg/sec * Stab Rate P so by default will be 45deg/sec.
#define AC_ATTITUDE_CONTROL_ACCEL_RP_MAX_DEFAULT_DSS   1080.0f // default maximum acceleration for roll/pitch axis in centidegrees/sec/sec
